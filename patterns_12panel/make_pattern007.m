function make_pattern007()
    ...
    InitPat = ShiftMatrix([zeros(4,36) 1.*ones(4,1) 2.*ones(4,1) 3.*ones(4,1) 4.*ones(4,1) 5.*ones(4,1) 6.*ones(4,1) 7.*ones(4,2) 6.*ones(4,1) 5.*ones(4,1) 4.*ones(4,1) 3.*ones(4,1) 2.*ones(4,1) 1.*ones(4,1) zeros(4,46)], 1, 'r', 'y');
    % InitPat = [zeros(4,46) ones(4,4).*(2^pattern.gs_val-1) zeros(4,46)];
    Pats(:,:,1,1) = InitPat;
    ...
    str = [directory_name '\Pattern_007'] 	% name must begin with ‘Pattern_’
    save(str, 'pattern');
