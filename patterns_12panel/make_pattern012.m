function make_pattern012()
    ...
    SmallPat = zeros(4,8);
    SmallPat(3,:) = [0,0,0,0,(2^pattern.gs_val-1),(2^pattern.gs_val-1),(2^pattern.gs_val-1),(2^pattern.gs_val-1)];
    ...
    str = [directory_name '\Pattern_012'] 	% name must begin with ‘Pattern_’
    save(str, 'pattern');
