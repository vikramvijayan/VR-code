...
InitPat = [ones(5,142).*(2^pattern.gs_val-1) zeros(5,4) ones(5,46).*(2^pattern.gs_val-1)];
Pats(:,:,1,1) = InitPat;
...
str = [directory_name '\Pattern_006'] 	% name must begin with ‘Pattern_’
save(str, 'pattern');
