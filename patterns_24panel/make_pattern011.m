...
% InitPat(18:23,144-19:145+19) = 1;

InitPat = [zeros(5*8,141).*(2^pattern.gs_val-1) ones(5*8,6) zeros(5*8,45).*(2^pattern.gs_val-1)];
Pats(:,:,1,1) = InitPat;
...
str = [directory_name '\Pattern_011'] 	% name must begin with ‘Pattern_’
save(str, 'pattern');
