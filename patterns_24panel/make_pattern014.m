...
InitPat = zeros(5*8,192);

InitPat(1:20,(145-12):(145+12)) = 1;
InitPat(21:40,(145-12-96):(145+12-96)) = 1;
...
str = [directory_name '\Pattern_014'] 	% name must begin with ‘Pattern_’
save(str, 'pattern');
