...
InitPat = [ones(5*8,141).*(2^pattern.gs_val-1) zeros(5*8,6) ones(5*8,45).*(2^pattern.gs_val-1)];
Pats(:,:,1,1) = InitPat;
...
str = [directory_name '\Pattern_039'] 	% name must begin with ‘Pattern_’
save(str, 'pattern');
